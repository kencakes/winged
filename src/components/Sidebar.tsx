...
import { Settings, LogOut, Home, PawPrint, Bird, Egg, Book, ChevronRight } from "lucide-react";
        ...
        <div className='relative pt-20 border-r'>
            ...
            {!mobileWidth && (
                <div className='absolute right-[-15px] top-7' >
                    <Button className='rounded-full w-7 h-7 p-1' variant="outline" size="icon" onClick={toggleSiderbar} >
                        <ChevronRight />
                    </Button>
                </div>
            )}
